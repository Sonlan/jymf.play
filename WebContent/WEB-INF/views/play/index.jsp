...
<script type="text/javascript">
	function subForm(){
		document.getElementById("drawAward").submit();
	}
</script>
		...
		<div id="content" class="snap-content">
			<div class="slider-container full-bottom">
				...
				<div class="erweima_info">
					<h4>扫码有礼，诚信有奖</h4>
					<p class=“center-text”>活动期间首次通过APP验证产品真伪均可获得一次
						抽取苹果最新手机的机会，多扫多得，诚信有奖，中奖率高，机不可失！</p>
				</div>
			...
			<div class="footer">
				<div class=" half-bottom ">
					<a href="#"
						class="footer-share show-share-bottom button button-red" onclick="subForm();">点击抽手机</a>
				</div>
				<form id="drawAward" action="${ctx}/play/drawAward" method="post">
					<input type="hidden" name="allString" value='${allString}'>
				</form>
			</div>
		</div>
	</div>
